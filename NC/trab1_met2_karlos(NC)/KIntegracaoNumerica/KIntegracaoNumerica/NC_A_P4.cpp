...
double NC_A_P4::NC_A_P4_integracao(Funcao * f, double a, double b)
{
    ...
    return ((h*(3.0/10.0))*(11.0*m_pIntegrando->f(a+h)- 14.0*m_pIntegrando->f(a+2.0*h) + 26.0*m_pIntegrando->f(a+3.0*h) - 14.0*m_pIntegrando->f(a+4.0*h) +11.0*m_pIntegrando->f(a+5.0*h)));
